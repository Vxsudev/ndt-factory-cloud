...
import { AssemblerWorkflowView } from './AssemblerWorkflowView'
import { FloorManagerWorkflowView } from './FloorManagerWorkflowView'
  ...
  return (
    <div data-workflow-first-view="true">
      ...
      {vm.units.length === 0 && !vm.loadError ? (
        ...
        <AssemblerWorkflowView vm={vm} />
      ) : (
        <FloorManagerWorkflowView vm={vm} />
      )}
    </div>
  )
}
