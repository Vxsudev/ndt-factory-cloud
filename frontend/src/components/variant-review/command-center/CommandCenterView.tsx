...
import { AssemblerCommandView } from './AssemblerCommandView'
import { FloorManagerCommandView } from './FloorManagerCommandView'
...
export function CommandCenterView() {
  ...
  return (
    <div data-command-center-view="true">
      ...
      {vm.units.length === 0 && !vm.loadError ? (
        ...
        <AssemblerCommandView vm={vm} />
      ) : (
        <FloorManagerCommandView vm={vm} />
      )}
    </div>
  )
}
